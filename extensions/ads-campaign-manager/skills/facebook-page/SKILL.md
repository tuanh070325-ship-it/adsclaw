...
$r2 = Invoke-RestMethod "https://graph.facebook.com/v19.0/$pageId?fields=access_token&access_token=$($r1.access_token)"
...
**GET:**
```powershell
$result = Invoke-RestMethod -Uri "https://graph.facebook.com/v19.0/ENDPOINT?access_token=$token" -ErrorAction Stop
```

**POST (form body):**
```powershell
$result = Invoke-RestMethod -Uri "https://graph.facebook.com/v19.0/ENDPOINT" -Method POST `
    -Body @{ field1="value1"; field2="value2"; access_token=$token } -ErrorAction Stop
```

**DELETE:**
```powershell
$result = Invoke-RestMethod -Uri "https://graph.facebook.com/v19.0/{id}?access_token=$token" -Method DELETE -ErrorAction Stop
```
...
$result = Invoke-RestMethod -Uri "https://graph.facebook.com/v19.0/$pageId/photos" -Method POST `
...
$result   = Invoke-RestMethod -Uri "https://graph.facebook.com/v19.0/$pageId/feed" -Method POST `
